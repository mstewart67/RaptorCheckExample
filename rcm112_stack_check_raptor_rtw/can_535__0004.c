...
/* Functions */
void pre_start_CAN_535__0004(void)
{
}                                      // end pre_start_CAN_535__0004

void CAN_ReceiveDispatch_535__0004(uint8 IdType, uint32 Id, uint8* data, uint8
...
const tBiosCanBitRates CAN_CAN5_LOCAL_baud_rate = BIOS_MCAN_BR_500KBPS;
uint32_T CAN_CAN5_LOCAL_get_baud_rate(void)
{
  uint32_T baud_rate;
  switch (CAN_CAN5_LOCAL_baud_rate)
  {
...
void post_start_CAN_535__0004(void)
{
  if (started_535__0004) {
    return;
  }

  started_535__0004 = 1;
  Bios_Can_RegisterRxCallBack (BIOS_MCAN_5, CAN_ReceiveDispatch_535__0004);
  Bios_Can_Start(BIOS_MCAN_5,
                 &raptor_can_SubMcan_DataBitTimings[BIOS_MCAN_DBR_500KBPS],
                 &raptor_can_SubMcan_NominalBitTimings[CAN_CAN5_LOCAL_baud_rate]);
}                                      // end post_start_CAN_535__0004

void CANBusOff_Recovery_CAN5_LOCAL(void)
{
  if ((Bios_Can_GetError (BIOS_MCAN_5) & (uint16)
