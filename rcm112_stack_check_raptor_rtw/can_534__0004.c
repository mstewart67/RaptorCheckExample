...
/* Functions */
void pre_start_CAN_534__0004(void)
{
}                                      // end pre_start_CAN_534__0004

void CAN_ReceiveDispatch_534__0004(uint8 IdType, uint32 Id, uint8* data, uint8
...
const tBiosCanBitRates CAN_CAN4_LOCAL_baud_rate = BIOS_MCAN_BR_500KBPS;
uint32_T CAN_CAN4_LOCAL_get_baud_rate(void)
{
  uint32_T baud_rate;
  switch (CAN_CAN4_LOCAL_baud_rate)
  {
...
void post_start_CAN_534__0004(void)
{
  if (started_534__0004) {
    return;
  }

  started_534__0004 = 1;
  Bios_Can_RegisterRxCallBack (BIOS_MCAN_4, CAN_ReceiveDispatch_534__0004);
  Bios_Can_Start(BIOS_MCAN_4,
                 &raptor_can_SubMcan_DataBitTimings[BIOS_MCAN_DBR_500KBPS],
                 &raptor_can_SubMcan_NominalBitTimings[CAN_CAN4_LOCAL_baud_rate]);
}                                      // end post_start_CAN_534__0004

void CANBusOff_Recovery_CAN4_LOCAL(void)
{
  if ((Bios_Can_GetError (BIOS_MCAN_4) & (uint16)
